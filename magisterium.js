...
dotenv.config();
function getMagisteriumAnswer() {
    return __awaiter(this, void 0, void 0, function () {
        var apiKey, response, errorText, results, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 6, , 7]);
                    return [4 /*yield*/, fetch('https://www.magisterium.com/api/v1/chat/completions', {
                            method: 'POST',
                            headers: {
                ...
                case 6:
                    error_1 = _a.sent();
                    console.error('Error calling Magisterium API:', error_1);
                    return [3 /*break*/, 7];
